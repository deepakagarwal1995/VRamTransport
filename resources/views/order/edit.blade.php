         ...
         <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-0 overflow-x-auto">
                            <div class="flex-auto p-6">
                                  <form action="{{ route('order.update', $orderDetail->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="number" name="orderNo" value="{{ $orderDetail->orderNo }}"
                            ...
                            @enderror
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="date" name="orderDate" value="{{ $orderDetail->orderDate }}"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                            ...
                            @enderror
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="text"  name="deliveryparty" value="{{ $orderDetail->deliveryparty }}"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                 aria-label="Name" aria-describedby="email-addon"
                                                autocomplete="off">
                                                 @error('deliveryparty')
                            ...
                            @enderror
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="text"  name="deliveryDest1" value="{{ $orderDetail->deliveryDest1 }}"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                 aria-label="Name" aria-describedby="email-addon"
                                                autocomplete="off">
                                                  @error('deliveryDest1')
                            ...
                            @enderror
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="text"  name="deliveryDest2" value="{{ $orderDetail->deliveryDest2 }}"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                 aria-label="Name" aria-describedby="email-addon"
                                                autocomplete="off">
                                                  @error('deliveryDest2')
                            ...
                            @enderror
                                         ...
                                         <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="number"  value="{{ $orderDetail->orderWt }}" name="orderWt" min="0" value="0" step="any"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                 aria-label="Name" aria-describedby="email-addon"
                                                autocomplete="off">
                                                  @error('orderWt')
