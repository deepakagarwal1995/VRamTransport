                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="number" name="orderNo"
                                                ...
                                                autocomplete="off" value="{{ $ordertransport->orderNo }}" readonly>
                                            @error('orderNo')
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-4/12">
                                            <label class="mb-0 text-xs font-semibold leading-tight">Empty Vehicle Weight<span
                                                    class="text-rose-700">*</span></label>
                                            <input type="number" min="0" value="0" step="any" name="emptyVehicleWt" id="emptywgt"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-4/12">
                                            ...
                                            <input type="number" min="0" value="0" step="any" name="grossLoadedVehicleWt" id="grosswgt"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-4/12">
                                            ...
                                            <input type="number" min="0" value="0" step="any" id="netwgt"  name="netVehicleWt"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
                                            @error('netVehicleWt')
                                                <p class="text-red-500 mt-2">{{ $message }}</p>
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            <label class="mb-0 text-xs font-semibold leading-tight">Loaded weight at {{ $ordertransport->orderDetails->deliveryDest1 }}<span
                                                    class="text-rose-700">*</span></label>
                                            <input type="number" min="0" value="0" step="any" name="destination1loadedWt"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
                                         ...
                                         <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            <label class="mb-0 text-xs font-semibold leading-tight">Empty weight at {{ $ordertransport->orderDetails->deliveryDest1 }}<span
                                                    class="text-rose-700">*</span></label>
                                            <input type="number" min="0" value="0" step="any" name="destination1emptyWt"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
                                         ...
                                         <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            <label class="mb-0 text-xs font-semibold leading-tight">Loaded weight at {{ $ordertransport->orderDetails->deliveryDest2 }} </label>
                                            <input type="number" min="0" value="0" step="any" name="destination2loadedWt"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
                                         ...
                                         <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            <label class="mb-0 text-xs font-semibold leading-tight">Empty weight at {{ $ordertransport->orderDetails->deliveryDest2 }} </label>
                                            <input type="number" min="0" value="0" step="any" name="destination2emptyWt"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
