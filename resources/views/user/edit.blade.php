                                 ...
                                 <div class="flex flex-wrap -mx-3">
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="text" name="name"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                placeholder="Name" aria-label="Name" aria-describedby="email-addon" value="{{ $User->name }}"
                                                autocomplete="off" required>
                                            @error('name')
                                                <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="email" name="email"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="email" aria-describedby="email-addon" value="{{ $User->email }}" autocomplete="off">
                                            @error('email')
                                                <p class="text-red-500 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            <label class="mb-0 text-xs font-semibold leading-tight">New Password <span
                                                    class="text-rose-700">(Left Blank For no change)</span></label>
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            <label class="mb-0 text-xs font-semibold leading-tight">Confirm Password <span class="text-rose-700">(Left Blank For no change)</span></label>
