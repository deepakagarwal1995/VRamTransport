         ...
         <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-0 overflow-x-auto">
                            <div class="flex-auto p-6">
                                  <form action="{{ route('transport.update', $orderTransport->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="number" name="orderNo" value="{{ $orderTransport->orderNo }}"
                            ...
                            @enderror
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="text" name="name" value="{{ $orderTransport->name }}"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            <label class="mb-0 text-xs font-semibold leading-tight">Vehicle No <span
                                                    class="text-rose-700">*</span></label>
                                            <input type="text" name="vehicleNo" value="{{ $orderTransport->vehicleNo }}"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
                                            @error('vehicleNo')
                                                <p class="text-red-500 mt-2">{{ $message }}</p>
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="text" name="vehicleOwner" value="{{ $orderTransport->vehicleOwner }}"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
                                            @error('vehicleOwner')
                                                <p class="text-red-500 mt-2">{{ $message }}</p>
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            <label class="mb-0 text-xs font-semibold leading-tight">Driver Name <span
                                                    class="text-rose-700">*</span></label>
                                            <input type="text" name="vehicleDriver" value="{{ $orderTransport->vehicleDriver }}"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
                                            @error('vehicleDriver')
                                                <p class="text-red-500 mt-2">{{ $message }}</p>
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            <label class="mb-0 text-xs font-semibold leading-tight">Driver Mobile<span
                                                    class="text-rose-700">*</span></label>
                                            <input type="number" name="driverMob" value="{{ $orderTransport->driverMob }}"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
                                            @error('driverMob')
                                                <p class="text-red-500 mt-2">{{ $message }}</p>
                                        ...
                                        <div class="w-full max-w-full px-3 mb-2 md:w-6/12 md:flex-none xl:w-6/12">
                                            ...
                                            <input type="number" name="additionalCharges"  value="{{ $orderTransport->additionalCharges }}"
                                                class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                                aria-label="Name" aria-describedby="email-addon" autocomplete="off">
